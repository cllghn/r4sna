...
```{r, echo = FALSE, fig.cap='Default RStudio Interface'}
knitr::include_graphics("imgs/start_rstudio.PNG")
```
...
```{r project, echo = FALSE, fig.cap='Starting an RStudio Project'}
knitr::include_graphics("imgs/0_start_project.PNG")
```
...
```{r openproject, echo = FALSE, fig.cap='Opening RStudio Project'}
knitr::include_graphics("imgs/0_open_project.PNG")
```
