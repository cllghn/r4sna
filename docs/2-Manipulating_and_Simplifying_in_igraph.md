...
```
IGRAPH 8bc49d8 UNW- 67 183 -- 
+ attr: id (v/c), name (v/c), x (v/n), y (v/n), z (v/n), weight (e/n)
+ edges from 8bc49d8 (vertex names):
...
```
IGRAPH 8c7e9fe UNW- 3 183 -- 
+ attr: name (v/x), weight (e/n)
+ edges from 8c7e9fe (vertex names):
...
```
IGRAPH 8ed1542 DN-- 18 202 -- 
+ attr: name (v/c), Weight (e/n), Relation (e/c)
+ edges from 8ed1542 (vertex names):
